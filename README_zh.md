<p align="center">
  ...
  <p align="center"><strong>自带控制台的 QQ AI 自动回复机器人</strong></p>
  ...
  <p align="center">
    ...
    <img src="https://img.shields.io/badge/macOS-推荐-brightgreen?logo=apple&logoColor=white" alt="macOS 推荐">
  </p>
  <p align="center">
    <a href="#功能特性">功能</a> ·
    <a href="#界面预览">预览</a> ·
  ...
  <p align="center">
    ...
    <a href="./README_zh.md"><img src="https://img.shields.io/badge/🇨🇳_简体中文-4361ee?style=for-the-badge" alt="简体中文"></a>
  </p>
</p>
...
- **自己配 API Key** — 支持 DeepSeek、阿里云百炼 (Qwen)、OpenRouter、Claude 等任意 OpenAI 兼容平台，用自己的额度
- **自定义角色性格** — 内置猫娘 / 助手 / 程序员，也能随手创建自己的角色 (System Prompt)
- **扫码换号** — 控制台一键连接 NapCat，扫码登录，随时切换 QQ 账号
- **多 QQ 应用自动检测** — 自动扫描本机所有 QQ 安装（如 QQ.app、QQ_小号.app），在控制台一键切换，无需手动配置路径
- **上下文对话** — 自动回复私聊消息，记住最近对话内容
- **跨平台** — macOS 和 Windows 均可运行（推荐 macOS 以获得最佳稳定性）
...
| 角色管理 | 模型配置 |
|:---:|:---:|
| ![角色管理](image/主界面(角色).png) | ![模型配置](image/模型界面.png) |

| 连接管理（支持多 QQ 应用切换） | 参数设置 |
|:---:|:---:|
| ![连接管理](image/连接界面.png) | ![设置](image/设置界面.png) |
...
<a href="#macos-部署">
  <img src="https://img.shields.io/badge/macOS-部署教程_(推荐)-000000?style=for-the-badge&logo=apple&logoColor=white" alt="macOS">
</a>
&nbsp;&nbsp;
<a href="#windows-部署">
...
控制台会**自动检测本机所有 QQ 安装**。如果你有多个 QQ 应用（例如用于不同账号），它们会全部显示为可选项 —— 选择一个点击连接即可。

连接后扫码登录，随时可断开并切换到其他 QQ 号。
